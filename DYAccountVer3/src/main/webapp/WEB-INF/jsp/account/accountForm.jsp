...
<head>
    ...
    <script>
        ...
        function showAccount() {
            ...
            $.ajax({
                type: "GET",
                url: "${pageContext.request.contextPath}/account/ParentAccountList",
                dataType: "json",
        ...
        function showAccountDetail(code) {
           $(accountDetailGrid).jqGrid("clearGridData");
            ...
            $.ajax({
                type: "GET",
                url: "${pageContext.request.contextPath}/account/DetailAccountList",
                data: {
                    "code": code
                },
                dataType: "json",
                success: function (jsonObj) {
                    // set the new data
                    $(accountDetailGrid).jqGrid('setGridParam', {data: jsonObj});
                    // hide the show message
