...
<head>
    ...
    <script type="text/javascript">
        ...
        function showApprovalSlipGrid() {
            ...
            $.ajax({
                type: "GET",
                url: "${pageContext.request.contextPath}/account/findDisApprovalSlipList.do",
                dataType: "json",
        ...
        function showJournalGrid(slipNo) {
            ...
            $.ajax({
                type: "GET",
                url: "${pageContext.request.contextPath}/account/findSingleJournalList.do",
                data: {
                    "slipNo": slipNo
                },
                dataType: "json",
        ...
        function showJournalDetailGrid(journalNo) {
            ...
            $.ajax({
                type: "GET",
                url: "${pageContext.request.contextPath}/account/getJournalDetailList.do",
                data: {
                    "journalNo": journalNo
                },
                dataType: "json",
        ...
        function approveSelectedSlip(isApprove) {
            ...
            $.ajax({
                type: "GET",
                url: "${pageContext.request.contextPath}/account/approveSlip.do",
                data: {
