    ...
    <script>
        ...
        function saveEmployee() {
            ...
            function saveEmployeeData() {
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/hr/batchEmpInfo.do",
                    type: "post",
                    data: {
        ...
        function createEmployeeList() {
            ...
            $(employeeListGrid).jqGrid({
                ...
                onSelectRow: function (key) {
                    ...
                    $.ajax({
                        type: "GET",
                        url: "${pageContext.request.contextPath}/hr/findEmployee.do",
                        data: {
                            "empCode": key
                        },
                        dataType: "json",
        ...
        function showEmployeeList() {
            ...
            $.ajax({
                type: "GET",
                url: "${pageContext.request.contextPath}/hr/findEmployeeList.do",
                data: {
        ...
        function showDeptList() {
            ...
            $.ajax({
                type: "GET",
                url: "${pageContext.request.contextPath}/base/getDetailCodeList.do",
                data: {
        ...
        function deleteEmployeeFunc(){
        	$.ajax({
        		url : "${pageContext.request.contextPath}/hr/deleteEmployee.do",
        		data : {
