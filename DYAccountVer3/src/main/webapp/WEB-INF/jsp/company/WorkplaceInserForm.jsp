...
<script>
	...
	function getWorkplaceCode(code) {
		...
		$.ajax({
					type : "GET",
					url : "${pageContext.request.contextPath}/company/Workplace",
					data : {
						"workplaceCode" : codeCheck
					},
					dataType : "json",
					success : function(jsonObj) {
						var workplaceCode = jsonObj;
	...
	function showParentBusiness() { //업태리스트
		...
		$.ajax({
			type : "GET",
			url : "${pageContext.request.contextPath}/company/BusinessList",
			dataType : "json",
			success : function(jsonObj) {
				console.log(jsonObj);
				// set the new data
	...
	function showDetailBusinessGrid(businessCode) { //업태소분류리스트
		...
		$.ajax({
			type : "GET",
			url : "${pageContext.request.contextPath}/company/DetailBusiness",
			data : {
