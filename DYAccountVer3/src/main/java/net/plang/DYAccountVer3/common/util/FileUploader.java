/*
 * package net.plang.DYAccountVer3.common.util;
 * 
 ...
 * 
 * 
 * public static String doFileUpload(FileItem fileItem, String empId) throws
 * IOException { InputStream in = fileItem.getInputStream();
 * 
 * String realFileName =
 ...
 * in.read(buffer, 0, 8192)) != -1) fout.write(buffer, 0, bytesRead);
 * 
 * in.close(); fout.close();
 * 
