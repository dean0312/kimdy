...
import net.plang.DYAccountVer3.common.servlet.ModelAndView;
import net.plang.DYAccountVer3.common.servlet.controller.AbstractController;
...
public class EmailManagement extends AbstractController{
	...
	public ModelAndView handleRequestInternal(HttpServletRequest request, HttpServletResponse response){
		...
		String pdfBaseUrl = "C:\\Users\\wooya\\project\\DYAccount\\WebContent\\resources\\reportform\\report11.pdf";
...
String recipient = email+"@"+emailOption; // 받는 사람의 이메일
		...
		msg.setFrom(new InternetAddress("seoulittest1@naver.com","DYAccount")); // 2번째 문자열은 발송자 이름입니다. 변경하세요
