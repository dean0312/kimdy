...
<script>
        ...
        function createPdf() {
        	$("#sendPdf").prop("disabled",false);
        	   window.open("${pageContext.request.contextPath}/base/report.html?method=slipDetailIreport&slipNo=" + $(slipGrid).jqGrid('getGridParam',"selrow"), "window", "width=1600, height=1000");
        	   
        }
        //EXCEL로 보기
        function createExcel(){
        	
        	location.href="${pageContext.request.contextPath}/base/excel.html?method=slipExcel&from=" + $("#from").val()+"&to="+$("#to").val();
        }
        ...
        function showJournalDetailSubGrid(parentRowId, parentRowKey) {
            ...
            $.ajax({
                ...
                dataType: "json",
                success: function (jsonObj) {
                	console.log(jsonObj.journalDetailList);
                    // set the new data
